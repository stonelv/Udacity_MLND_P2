...
from media import Tv_Show

'''Create a Movie Object（Toy Story）'''
toy_story = Movie('Toy Story', 110, 
...
breaking_bad_s1e1 = Tv_Show('Breaking Bad', 45, 'Pilot', 
...
breaking_bad_s1e2 = Tv_Show('Breaking Bad', 45, 'Cat\'s in the bag', 
	'https://i.pinimg.com/736x/a4/b9/de/a4b9de044d3967643e70a87827523ef2--breaking-bad-poster-jesse-pinkman.jpg', 
